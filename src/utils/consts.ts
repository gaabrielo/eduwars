...
export const PLACEMENT_TYPE_DECORATIVE = "DECORATIVE";
export const PLACEMENT_TYPE_WARDROBE = "WARDROBE";
export const PLACEMENT_TYPE_CLASSROOM = "CLASSROOM";
export const PLACEMENT_TYPE_NPC_BATTLE = "NPC_BATTLE";
